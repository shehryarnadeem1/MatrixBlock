            ...
            >
              ...
              <button
                ...
                className={`w-full py-3.5 rounded-xl border font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 transition-all relative overflow-hidden active:scale-[0.98] cursor-pointer ${
                  isWeb3Connected 
                    ? "bg-emerald-50 border-emerald-500/30 text-emerald-600 shadow-[0_0_15px_rgba(16,185,129,0.15)]" 
          ...
          {activeTab === "overview" && (
            <>
                ...
                {[
                  ...
                  return (
                    <motion.div
                      ...
                      className="glass-panel p-5 rounded-2xl flex flex-col gap-4 relative overflow-hidden group shadow-[0_8px_32px_0_rgba(147,51,234,0.02)]"
                    >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
                ...
                <motion.div variants={itemVariants} className="glass-panel p-6 rounded-3xl flex flex-col gap-6 border border-zinc-200/60 shadow-[0_8px_32px_0_rgba(147,51,234,0.02)] bg-white/40">
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="flex flex-col gap-3.5 flex-1 w-full">
                      ...
                      <div className="flex flex-col gap-1 pt-2 w-full">
                        ...
                        <div className="flex items-center justify-between bg-zinc-50 p-2.5 rounded-xl border border-zinc-200 gap-3 w-full">
                          ...
                          >
                            {copiedIndex === model.id ? <Check className="w-3.5 h-3.5 text-emerald-600" /> : <Copy className="w-3.5 h-3.5" />}
                          </button>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {burstCount > 0 && (
                        <motion.span 
                          ...
                          className="text-[9px] uppercase bg-purple-50 text-purple-600 px-2 py-0.5 rounded border border-purple-500/30 font-bold tracking-widest animate-pulse"
                        >
                          BURST ACTIVE
                        </motion.span>
                      )}
                ...
                >
                  ...
                  <div className="flex flex-col gap-3.5 bg-zinc-50 p-4.5 rounded-2xl border border-zinc-200/80 text-xs text-left">
                    ...
                    <div className="flex flex-col gap-1 py-1 border-b border-zinc-200">
                      ...
                      <span className="font-mono text-[10px] text-zinc-650 truncate">{purchasedReceipt.transactionHash}</span>
                    </div>
