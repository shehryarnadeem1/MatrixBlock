...
export default function Sidebar() {
  ...
  return (
    <aside className={`fixed md:sticky inset-y-0 md:inset-y-auto left-0 md:left-4 z-50 md:z-10 w-72 md:w-68 h-screen md:h-[calc(100vh-2rem)] flex flex-col justify-between p-6 rounded-none md:rounded-2xl glass-panel bg-zinc-950/40 md:bg-white/5 backdrop-blur-xl md:backdrop-blur-md border border-white/10 md:border-white/10 select-none transform transition-transform duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] ${
      isOpen 
        ? "translate-x-0 shadow-[0_0_30px_rgba(147,51,234,0.15)] border-purple-500/20" 
        : "translate-x-[-100%] md:translate-x-0 shadow-2xl"
    }`}>
